...
const Details = ({ title, description, complexity, duration_in_minutes, resources, instructions, instructionIndex, setInstructionIndex, image }) => {
  return (
    <div className='text-white w-full overflow-y-auto mb-4'>
      {image && <img src={project} alt='project' className='mx-auto max-w-xl' />}
