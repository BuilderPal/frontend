    ...
    <div className="flex justify-between">
      {
        recordedBlob
          ...
          : isRecording
            ...
            : (
              <>
                <button onClick={startRecording} type="button" className="  bg-blue-500 hover:bg-blue-400inline-flex items-center justify-center rounded-full h-12 w-16 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-6 w-10 text-white">
