                ...
                <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
                    <div className="flex items-center transition-all duration-500 ease-in-out">
                        ...
                        <button className="flex-shrink-0p-4">
                            <Button disabled={isAwaitingResponse} onClick={sendMessage} type="button" className="items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out bg-blue-500 hover:bg-blue-400 focus:outline-none disabled:bg-slate-400">
