...
export default function Loader ({ messages = ['Thinking hard...'] }) {
  const [currentMessage, setCurrentMessage] = useState(messages[0])
  const [messageIndex, setMessageIndex] = useState(0)

  useEffect(() => {
    const intervalId = setInterval(() => {
      // Update the index to show the next message
      setMessageIndex((prevIndex) => (prevIndex + 1) % messages.length)
    }, 8000) // changes message every 5 seconds
  ...
  return (
        <div className="page-loader">
            ...
            <div className="page-loader-decoration">
                ...
                <svg className="icon-logo" viewBox="0 0 28 40" preserveAspectRatio="xMinYMin meet">
            ...
            <div className="page-loader-info">
                ...
                <p className="page-loader-info-title">BuilderPal</p>

                <p className="page-loader-info-text">{currentMessage}</p>
