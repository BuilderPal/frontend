                    ...
                    breadcrumbs.slice(1, breadcrumbs.length).map((breadcrumb, index) => (
                        <li key={index}>
                            <div className="flex items-center">
                                ...
                                <a href="#" onClick={() => navigateToIteration(index + 1)} className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{breadcrumb}</a>
                            </div>
                        </li>
                    ))
                }
